              ...
              <div className="tabela table border-collapse">
                ...
                >
                  ...
                  >
                    ...
                    <div className="p-2 text-center w-[150px]">Banco</div>
                    <div className="p-2 text-center w-[90px]">Licenças</div>
                    <div className="p-2 text-center w-[110px]">$ - Venda</div>
                    <div className="p-2 text-center w-[110px]">$ - Custo</div>
                    <div className="p-2 text-center w-[110px]">Lucro</div>
                    <div className="p-2 text-center w-[110px]">Confirmado</div>
